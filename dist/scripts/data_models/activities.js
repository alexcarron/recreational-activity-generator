...
export const activities = [
    new Activity({
        name: "Walk",
        description: "",
        duration_range: new NumRange(new Duration(10, UnitOfTime.Minutes), new Duration(1, UnitOfTime.Hours)),
        required_focuses: [],
        required_devices: [],
    ...
    new Activity({
        ...
        duration_range: new NumRange(new Duration(30, UnitOfTime.Minutes), new Duration(12, UnitOfTime.Hours)),
    ...
    new Activity({
        ...
        duration_range: new NumRange(new Duration(15, UnitOfTime.Minutes), new Duration(12, UnitOfTime.Hours)),
        required_focuses: [Focus.Engagement, Focus.Social, Focus.Visual],
        required_devices: [Item.Computer],
        num_participants_needed: new NumRange(5, 30),
        needInternet: true,
        isProductive: YesNoCheckbox.No,
        enjoyment_level: EnjoymentLevel.Enjoyable,
        required_place: Place.Home
    ...
    new Activity({
        ...
        duration_range: new NumRange(new Duration(1, UnitOfTime.Minutes), new Duration(12, UnitOfTime.Hours)),
    ...
    new Activity({
        name: "Check Discord",
        description: "",
        duration_range: new NumRange(new Duration(0, UnitOfTime.Minutes), new Duration(10, UnitOfTime.Minutes)),
        required_focuses: [Focus.Textual],
        required_devices: [Item.Phone],
        num_participants_needed: new NumRange(1, 1),
        needInternet: true,
    ...
    new Activity({
        ...
        duration_range: new NumRange(new Duration(0, UnitOfTime.Minutes), new Duration(3, UnitOfTime.Minutes)),
        required_focuses: [Focus.Textual],
        required_devices: [Item.Phone],
        num_participants_needed: new NumRange(1, 1),
        needInternet: true,
    ...
    new Activity({
        ...
        description: "",
        duration_range: new NumRange(new Duration(0, UnitOfTime.Minutes), new Duration(15, UnitOfTime.Minutes)),
    ...
    new Activity({
        ...
        duration_range: new NumRange(new Duration(0, UnitOfTime.Minutes), new Duration(20, UnitOfTime.Minutes)),
    ...
    new Activity({
        ...
        duration_range: new NumRange(new Duration(3, UnitOfTime.Minutes), new Duration(30, UnitOfTime.Minutes)),
    ...
    new Activity({
        name: "Watch a Movie",
        description: "",
        duration_range: new NumRange(new Duration(1, UnitOfTime.Hours), new Duration(4, UnitOfTime.Hours)),
        required_focuses: [Focus.Auditory, Focus.Visual],
        required_devices: [Item.Computer],
        num_participants_needed: new NumRange(1, 1),
        needInternet: true,
    ...
    new Activity({
        name: "Watch Anime",
        description: "",
        duration_range: new NumRange(new Duration(25, UnitOfTime.Minutes), new Duration(12, UnitOfTime.Hours)),
        required_focuses: [Focus.Auditory, Focus.Visual],
        required_devices: [Item.Computer],
        num_participants_needed: new NumRange(1, 1),
        needInternet: true,
    ...
    new Activity({
        ...
        required_focuses: [Focus.Engagement, Focus.Visual],
        required_devices: [Item.Computer],
        num_participants_needed: new NumRange(1, 25),
        needInternet: true,
        isProductive: YesNoCheckbox.No,
        enjoyment_level: EnjoymentLevel.Enjoyable,
        required_place: Place.Anywhere
    ...
    new Activity({
        ...
        num_participants_needed: new NumRange(1, 8),
        needInternet: false,
        isProductive: YesNoCheckbox.No,
        enjoyment_level: EnjoymentLevel.Enjoyable,
        required_place: Place.Home
    ...
    new Activity({
        name: "Do Anki Notes",
        description: "",
        duration_range: new NumRange(new Duration(0, UnitOfTime.Minutes), new Duration(12, UnitOfTime.Hours)),
        required_focuses: [Focus.Textual, Focus.Engagement],
        required_devices: [Item.Phone],
        num_participants_needed: new NumRange(1, 1),
        needInternet: true,
    ...
    new Activity({
        ...
        description: "",
        duration_range: new NumRange(new Duration(5, UnitOfTime.Minutes), new Duration(30, UnitOfTime.Minutes)),
        required_focuses: [Focus.Textual, Focus.Engagement],
        required_devices: [Item.Computer],
        num_participants_needed: new NumRange(1, 1),
        needInternet: true,
    ...
    new Activity({
        ...
        description: "",
        duration_range: new NumRange(new Duration(1, UnitOfTime.Minutes), new Duration(15, UnitOfTime.Minutes)),
        required_focuses: [],
    ...
    new Activity({
        ...
        duration_range: new NumRange(new Duration(1, UnitOfTime.Hours), new Duration(12, UnitOfTime.Hours)),
